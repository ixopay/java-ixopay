 ...
 */
@JsonPropertyOrder({
  MaybeStatusResponse.JSON_PROPERTY_SUCCESS
})
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = StatusErrorResponse.class, name = "StatusErrorResponse"),
  @JsonSubTypes.Type(value = StatusResponse.class, name = "StatusResponse"),
  @JsonSubTypes.Type(value = StatusErrorResponse.class, name = "false"),
  @JsonSubTypes.Type(value = StatusResponse.class, name = "true"),
})

public class MaybeStatusResponse {
  public static final String JSON_PROPERTY_SUCCESS = "success";
  private Boolean success;

  public MaybeStatusResponse() { 
  }

  public MaybeStatusResponse success(Boolean success) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public MaybeStatusResponse putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this MaybeStatusResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MaybeStatusResponse maybeStatusResponse = (MaybeStatusResponse) o;
    return Objects.equals(this.success, maybeStatusResponse.success)&&
        Objects.equals(this.additionalProperties, maybeStatusResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MaybeStatusResponse {\n");
...
static {
  ...
  mappings.put("MaybeStatusResponse", MaybeStatusResponse.class);
  JSON.registerDiscriminator(MaybeStatusResponse.class, "success", mappings);
}
}
