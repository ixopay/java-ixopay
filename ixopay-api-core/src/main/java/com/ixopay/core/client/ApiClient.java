...
public class ApiClient {
   ...
   *
   * @param apiUser Gateway API user.
   */
  public ApiClient(ApiUser apiUser) {
   ...
   */
  public ApiClient(ApiUser apiUser, HttpClient.Builder builder, ObjectMapper mapper, String baseUri) {
  ...
  protected ObjectMapper createDefaultObjectMapper() {
    ...
    mapper.registerModule(new GatewayDateTimeFormatsModule());
    return mapper;
  }

  public static class GatewayDateTimeFormatsModule extends SimpleModule {
    private static final long serialVersionUID = 1L;

    public GatewayDateTimeFormatsModule() {
      DateTimeFormatter dateTimeZone = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ssxxx");
      addSerializer(OffsetDateTime.class, new GatewayOffsetDateTimeSerializer(dateTimeZone));
    }

    private static class GatewayOffsetDateTimeSerializer extends OffsetDateTimeSerializer {
      public GatewayOffsetDateTimeSerializer(DateTimeFormatter formatter) {
  ...
  protected String getDefaultBaseUri() {
    return "https://gateway.ixopay.com/api/v3";
  }
 ...
 /**
  ...
  /**
   * Get the gateway API user.
   *
   * @return Gateway API user
   */
  ...
  /**
   * Set the gateway API user.
   *
   * @param apiUser gateway API user
   *
   * @return This object.
   */
  public ApiClient setApiUser(ApiUser apiUser) {
    this.apiUser = apiUser;
    return this;
  }
}
