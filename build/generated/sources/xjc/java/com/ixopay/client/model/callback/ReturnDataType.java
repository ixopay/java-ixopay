 ...
 *       &lt;choice&gt;
 *         &lt;element name="creditcardData" type="{http://gateway.ixopay.com/Schema/V2/Callback}creditcardDataType"/&gt;
 *         &lt;element name="phoneData" type="{http://gateway.ixopay.com/Schema/V2/Callback}phoneDataType"/&gt;
 *         &lt;element name="ibanData" type="{http://gateway.ixopay.com/Schema/V2/Callback}ibanDataType"/&gt;
 *         &lt;element name="walletData" type="{http://gateway.ixopay.com/Schema/V2/Callback}walletDataType"/&gt;
 *       &lt;/choice&gt;
 *       &lt;attribute name="type" use="required" type="{http://gateway.ixopay.com/Schema/V2/Callback}returnDataTypeEnum" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class ReturnDataType {
    ...
    protected WalletDataType walletData;
     ...
     * 
     */
    public ReturnDataType(final CreditcardDataType creditcardData, final PhoneDataType phoneData, final IbanDataType ibanData, final WalletDataType walletData, final ReturnDataTypeEnum type) {
     ...
     *     
     */
    public WalletDataType getWalletData() {
        return walletData;
    }
     ...
     *     
     */
    public void setWalletData(WalletDataType value) {
