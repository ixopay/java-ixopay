 ...
 *         &lt;element name="price" type="{http://gateway.ixopay.com/Schema/V2/Transaction}amountType" minOccurs="0"/&gt;
 *         &lt;element name="currency" type="{http://gateway.ixopay.com/Schema/V2/Transaction}currencyType" minOccurs="0"/&gt;
...
public class ItemType {
     ...
     * 
     */
    public ItemType(final String identification, final String name, final String description, final BigDecimal quantity, final BigDecimal price, final String currency, final List<ExtraDataType> extraData) {
