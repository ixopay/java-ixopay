...
/**
 * <p>Java class for cardAdditionalDataType complex type.
 * 
...
public class CardAdditionalDataType {
    ...
    protected List<ExtraDataType> dataRow;

    /**
     * Default no-arg constructor
     * 
     */
    public CardAdditionalDataType() {
        super();
    }
     ...
     * 
     */
    public CardAdditionalDataType(final List<ExtraDataType> dataRow) {
     ...
     * 
     */
    public List<ExtraDataType> getDataRow() {
        if (dataRow == null) {
            dataRow = new ArrayList<ExtraDataType>();
        }
        return this.dataRow;
    }
